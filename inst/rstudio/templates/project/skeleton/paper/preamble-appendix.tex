...
% Bibliography spacing: must match preamble.tex or the paper and its
% Internet Appendix disagree. This file shipped without these hooks
% while preamble.tex single-spaced its reference list, so the appendix
% silently inherited `linestretch: 2` and the two documents' reference
% lists were set at different leading. See preamble.tex for why this is
% \setstretch{2} and not setspace's \doublespacing.
